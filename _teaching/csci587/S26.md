...
- **Class Location:** [ZHS 352 (Zumberge Hall)](https://maps.usc.edu/?id=1928#!m/647097?share){:target="\_blank"}
...
An open-source web app for CSCI 587, developed by [Ketan Joshi](mailto:kajoshi@usc.edu), that lets you visualize and step through the spatial indexing algorithms and queries covered in this course — including Grid File, Z-Ordering, Hilbert Curves, Quadtrees, R-trees (point/range/kNN/RkNN), Skyline and Spatial Skyline queries, VoR-Tree, CNN, TPQ, and non-Euclidean (network) queries.

🔗 [csci587-class-study-app.vercel.app](https://csci587-class-study-app.vercel.app){:target="\_blank"}

The tool is an early MVP — feedback and contributions are welcome. Reach out to Ketan at [kajoshi@usc.edu](mailto:kajoshi@usc.edu).
